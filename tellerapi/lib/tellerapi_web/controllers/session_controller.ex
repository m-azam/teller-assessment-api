defmodule TellerapiWeb.SessionController do
  ...
  def enroll(conn, params) do
    ...
    case Tellerapi.BankInterface.auth(username, password, bank_name) do
      true ->
        #Tellerapi.Repo.insert(%Tellerapi.User{username: username, password: password, bank_name: bank_name})
        json(conn, %{auth_token: Tellerapi.Token.sign(%{user_name: username})})
      false ->
